...
//DoCompile = false;	//-- Compile all the project and engine source code (boolean). Generate all REL files
...
Emulator  = `${ToolsDir}Emulicious/Emulicious.jar`;
...
LibModules = [ "system", "bios", "vdp", "input", "memory", "print" ];
//
